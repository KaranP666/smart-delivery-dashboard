...
export default function PartnersPage() {
  ...
  return (
    <div className="p-6">
      ...
      <AddPartnerDialog
        onAdded={(newPartner) => setPartners((prev) => [...prev, newPartner])}
      />
          ...
          {partners.map((partner) => (
            ...
            >
              <div>
                ...
                <div
                  className={`inline-block px-2 py-1 text-sm font-medium rounded-md ${getStatusColor(
                    partner.status
                  )}`}
                >
                  {partner.status}
                ...
                <p className="text-sm text-gray-600 mt-2">
                  📦 Current Load:{" "}
                  <span className="font-medium">{partner.currentLoad}</span>
                </p>
              </div>
